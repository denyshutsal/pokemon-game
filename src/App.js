...
const App = () => {
  return (
    <>
      ...
      />
      <Layout id="rules" title="Section #1" urlBg={BackgroundImage1}>
        <p>
      ...
      <Layout id="cards" title="Section #2" colorBg="#a49da7">
        <div className="flex">
          {POKEMONS.map((item) => (
            <PokemonCard
              key={item.id}
      ...
      <Layout id="about" title="Section #3" urlBg={BackgroundImage3}>
        <p>
